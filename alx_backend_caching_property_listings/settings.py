...
SECRET_KEY = "django-insecure--%67_w25^wt2(s^8fm%w^uddu^y+v+idk1_cfd4i+)!qocmf=0"
...
CACHES = {
    "default": {
        ...
        "OPTIONS": {
            ...
            "IGNORE_EXCEPTIONS": True,  # prevents 500s if Redis is down
        },
        "KEY_PREFIX": "property_db",  # Prevents collisions with other apps
    }
}
